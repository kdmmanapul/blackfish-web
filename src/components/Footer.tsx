    ...
    <footer className="bg-black relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-8 py-16">
        ...
        >
          ...
          {/* Contact Info */}
          <motion.div variants={itemVariants}>
            <h4 className="text-white font-semibold uppercase tracking-wider mb-4 text-sm">
              Contact Information
            </h4>
            <ul className="space-y-3 text-white/70">
              <li className="flex items-start">
                ...
                <span className="text-sm">123 Whisper Lane, Downtown<br />New York, NY 10001</span>
              </li>
              <li className="flex items-start">
                <span className="text-gold mr-2">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <li className="flex items-start">
                ...
                <span className="text-sm">info@theblackroom.com</span>
              </li>
              <li className="flex items-start">
                <span className="text-gold mr-2">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <span className="text-sm">Tuesday - Sunday: 6:00 PM - 2:00 AM<br />Closed Mondays</span>
              </li>
            </ul>
          </motion.div>
          ...
          <motion.div variants={itemVariants}>
            ...
            <ul className="space-y-2">
              {['About', 'Menu', 'Events', 'Gallery', 'Contact', 'Reservations', 'Private Events', 'Careers'].map((item) => (
                <li key={item}>
                  <Link 
                    href={`#${item.toLowerCase().replace(' ', '-')}`} 
                    className="text-white/70 hover:text-gold transition-colors duration-300 text-sm flex items-center"
                  >
        ...
        <div className="pt-8 border-t border-gold/10">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              ...
              <Link href="/terms-of-service" className="text-white/50 hover:text-gold text-sm transition-colors duration-300">
                Terms of Service
              </Link>
            </div>
          </div>
